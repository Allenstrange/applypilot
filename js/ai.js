  ...
  anthropic: {
    ...
    async call(prompt, model, apiKey) {
      const resp = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({ model, max_tokens: 8192, temperature: 0.1, messages: [{ role: 'user', content: prompt }] })
      });
